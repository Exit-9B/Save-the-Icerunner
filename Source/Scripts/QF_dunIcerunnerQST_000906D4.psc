...
;BEGIN ALIAS PROPERTY SavedIcerunnerEnableMarker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_SavedIcerunnerEnableMarker Auto
;END ALIAS PROPERTY
...
;Disable wrecked Icerunner just in case
Alias_IcerunnerEnableMarker.GetReference().Disable()
Alias_RowboatEnableMarker.GetReference().Disable()

Alias_SavedIcerunnerEnableMarker.GetRef().Enable()
;END CODE
EndFunction
;END FRAGMENT
